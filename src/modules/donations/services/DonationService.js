...
class DonationService {
  static BASE_URL = API_URL + "/api/pre-donation"
  static BASE_URL2 = API_URL + "/api/campaign"
  static BASE_URL3 = API_URL + "/api/donations"
  static BASE_URL4 = API_URL + "/api/beneficiaries"
  ...
  static async getPrDonations(token) {
    ...
    console.log("URL:", `${this.BASE_URL}/pending`);
